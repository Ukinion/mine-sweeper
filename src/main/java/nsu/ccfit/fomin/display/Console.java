package nsu.ccfit.fomin.display;
...
import nsu.ccfit.fomin.exception.ActionParameterException;
...
import nsu.ccfit.fomin.objects.field.MineField;
...
public class Console implements PropertyChangeListener {
    ...
    private void initGame() throws GameException {
    ...
    private void openScoreTable() {
        ...
        for (Pair<String, Integer> player : playerList) {
            ...
            tableWindow.setLength(EMPTY_STRING.length());
        }
        System.out.println("\t**************************\n");
    }

    private void removePlayerRequest() throws GameException {
    ...
    private void addPlayerRequest() throws GameException {
    ...
    private void defineAction(String[] action) throws GameException {
    ...
    private void printGameField() {
        ...
        for (var i = 0; i < _gameField.getFieldRow(); ++i) {
            gameWindow.setLength(EMPTY_STRING.length());
